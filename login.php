...
<div class="container"  id="containerId" style="padding-top: 5%;">
    <div class="card card-container">
        ...
        <div class="col-auto col-lg-auto marca-logo mx-auto">
            <a class="brand" href="https://federaciondecafeteros.org/wp" rel="home">
                <img src="https://federaciondecafeteros.org/app/uploads/2021/01/Header-FNC-1.png" class="img-fluid" alt="Federación Nacional de Cafeteros">
            </a>
        </div>
        <br><br>
        <br><br>
